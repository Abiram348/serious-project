...
module "secrets" {
  ...
  database_url                  = "postgresql://orchestrator:${var.db_password}@${module.rds.db_instance_address}:5432/swarmdev"
...
module "cloudwatch" {
  ...
  log_retention_days          = 7
  node_autoscaling_group_name = module.eks.node_group_asg_name
